package com.ohgiraffers.sectrion03.filterstream.dto;

import java.io.Serializable;

public class MemberDTO implements Serializable { //implements Serializable 객체입출력할 클래스에는 있어야함(객체 내용을 직렬화 해)
