package com.ohgirafferse.section05.overloading;
...
public class OverloadingTest {
    ...
    *   Me : 자바는 매개변수명을 인식하지 못하고 타입만 인지하기 때문에 조건이 있음
    * */


    public void test() {}

//    public String test() {}  -> 메소드 시그니처(메소드명,파라미터)가 동일하여 같은 메소드로 인식 , 메소드의 반환형이 다른건 의미가 없다. (같은 메소드로 인식)

    //me => 아래의 경우 오버라이딩 활용

    /*설명. 매개변수의 갯수가 달라지면 같은 메소드명을 쓸 수 있음.*/
    public void test(int num) {}                  //매개변수가 다르다.
