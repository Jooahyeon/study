...
@Table(name = "tbl_member_section04")           // 기존 디비에 없는 테이블
public class Member {
    ...
    /* 설명. Enum 타입은 숫자(ORIDNAL)/이름(STRING) 두 가지 형태로 설정할 수 있다.(DB에 들어갈 값) */

    @Column(name = "member_role")
    @Enumerated(EnumType.STRING)                        // enum타입 문자열
//    @Enumerated(EnumType.ORDINAL)                     // enum타입 숫자
